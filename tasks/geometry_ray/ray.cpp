...
bool Ray::ContainsPoint(const Point& point) const {
    return Line(GetStart(), GetEnd()).ContainsPoint(point) &&
           ((GetEnd().GetX() >= GetStart().GetX() && GetStart().GetX() <= point.GetX()) ||
            (GetEnd().GetX() <= GetStart().GetX() && GetStart().GetX() >= point.GetX())) &&
           ((GetEnd().GetY() >= GetStart().GetY() && GetStart().GetY() <= point.GetY()) ||
            (GetEnd().GetY() <= GetStart().GetY() && GetStart().GetY() >= point.GetY()));
}
...
bool Ray::CrossesSegment(const Segment& segment) const {
    ...
    Vector v_start = segment.GetStart() - GetStart();
    Vector v_end = segment.GetEnd() - GetStart();
    Vector v_direction = GetEnd() - GetStart();
